...
const rules = authValidationRules.login
    ...
    <div class="auth-card">
      <div class="auth-header">
        <div class="logo-wrapper">
          <img :src="VITE_LOGO_URL" alt="Virtara Group Logo" class="auth-logo">
        </div>
        <h2>Giriş Yap</h2>
        <p class="auth-subtitle">Hesabınıza erişmek için giriş yapın</p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="auth-form">
        ...
        <div class="form-group">
          ...
          <div class="error-message" v-if="v$.password.$error">
            {{ v$.password.required.$message || 'Şifre en az 6 karakter olmalıdır' }}
          </div>
        </div>
        ...
        <div class="auth-links">
          <router-link to="/register" class="auth-link">Hesap Oluştur</router-link>
          <router-link to="/forgot-password" class="auth-link">Şifremi Unuttum</router-link>
        </div>
      </form>
    </div>
  </div>
